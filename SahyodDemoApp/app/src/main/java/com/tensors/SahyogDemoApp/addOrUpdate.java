...
public class addOrUpdate extends AppCompatActivity {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            ...
                            fileref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    map.put("url",url);
                                    db.collection(user.getEmail()).document(editroll.getText().toString()).set(map, SetOptions.merge()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
    ...
    private void sendTakePictureIntent() {
        ...
        if (cameraIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (pictureFile != null) {
                photoURI = FileProvider.getUriForFile(this, "com.tensors.SahyogDemoApp.fileprovider", pictureFile);
